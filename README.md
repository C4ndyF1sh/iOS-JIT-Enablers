...
**arm64 = A7-A11 | arm64e = A12+/M1+**
 ...
 | 17.4 - 18.3.2 / 18.4b2 - 18.5 | [SideStore "Nightly" build (required!)](https://github.com/SideStore/SideStore/releases/tag/nightly) + [Guide](https://sidestore.io) | iOS/iPadOS | arm64✅,arm64e✅ |No| ✅ (Recommended to use with StikDebug) |No|No|
 ...
 | ??? - 18.3.2 / 18.4b2 - 18.5 | [UTM SE](https://apps.apple.com/de/app/utm-se-retro-pc-emulator/id1564628856?l=en-GB) + [Guide](https://youtu.be/1LHTr3QZVwQ?si=esiE19BqI-aV7G49) | iOS/iPadOS | arm64🤷‍♂️,arm64e✅ |No| ❌ |No|No|
